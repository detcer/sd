<div id="header" class="header navbar-default">
    ...
    <div class="navbar-header">
        <a href="{{route('admin-root')}}" class="navbar-brand"><span class="navbar-logo"></span> <b>secret</b>Desire</a>
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-menu media-list dropdown-menu-right">
                ...
                <a href="javascript:;" class="dropdown-item media">
                    <div class="media-left">
                        <img src="/admin/assets/img/user/user-1.jpg" class="media-object" alt="" />
                ...
                <a href="javascript:;" class="dropdown-item media">
                    <div class="media-left">
                        <img src="/admin/assets/img/user/user-2.jpg" class="media-object" alt="" />
                        <i class="fab fa-facebook-messenger text-blue media-object-icon"></i>
                    </div>
                    <div class="media-body">
