        ...
        <tr class="odd gradeX">
            ...
            <td>
                ...
                <div class="switcher switcher-danger">
                    <input type="checkbox" name="block"  class="switcher_checkbox_blockUser"  @if($user->block) checked="" @endif id="switcher_checkbox_blockUser_{{$user->id}}" data-id="{{$user->id}}" value="1">
