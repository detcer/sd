...
<main>
    ...
    <form method="POST" action="{{ route('newModel') }}" class=" formModelUpdateAndNewValidate filling-lk dropzone " id="my-awesome-dropzone"  enctype='multipart/form-data'>
        @csrf
...
{{--                                <div id='file_field_preview' class="wrapPreviewImg"></div>--}}
...
{{--                                        Add photo--}}
{{--                                    </p>--}}
{{--                                    <input type="file" name="src_foto[]"  multiple value="{}" required id="file_field" style="display:none;"/>--}}
{{--                                </label>--}}
...
{{--                            </button>--}}
                            ...
                            <div class="input-box">
                                <input type="text" class="input-disabled" name="title" placeholder="Title" autocomplete="off"
                                       minlength="4" required  >
                            </div>

                            <div class="input-box">
										<textarea type="text" class="  minlength50 input-disabled textArea textArea__description" name="description"
                                                  placeholder="Description" minlength="50" pattern="[a-zA-Z][a-zA-Z0-9\s]*"  required style="height:300px;"></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="about-profile">
                            ...
                            <div class="FLEX-jc--sb">
                                ...
                                <!-- <div style="    min-width: 195px;">
                                    <div class="button-send-wrap--outline">
                                        <div id="BTN_addCity">
                                            Add city
                                        </div>
                            ...
                            <div class="select-box selectpickerMyStyle">
								<select name="state" required="" title="State" size="5" class="selectpicker" data-account="1" data-live-search="true" id="selectState" tabindex="-98">
									@include( 'components.states-shitcode' )
								</select>
                            </div>


                            <div class="select-box selectpickerMyStyle FLEX">
								<select name="city[]" required title="City" size="5" class="selectpicker" data-account="1" data-live-search="true" id="selectCity" multiple="" data-selected-text-format="count"></select>
                                </select>
                            ...
                            <div class="select-box selectpickerMyStyle FLEX ">
                                <select name="servises[]" id="inputServises" required title="Services" multiple size="5" class="selectpicker" data-live-search="true" data-selected-text-format="count">
                                    @foreach($params_services as $item)
                            ...
                            <div class="input-box">
                                <input type="text" class="input-disabled" name="name" placeholder="Name" required >
                            </div>

                            <div class="input-box">
                                <input type="tel" class="input-disabled" name="phone" placeholder="Phone" autocomplete="off" maxlength="12" required id="phone">
                            </div>
                            ...
                            <div style="width: 100%!important;max-width:100%!important;" class="select-box   w-100 d-block">
                                <select name="ethnicity" required style="width: 100%!important;max-width:100%!important;" class=" w-100 d-block selectpicker"  title="Ethnicity">
                            ...
                            <div class="select-container  w-100 d-block">
                                <div class="select-box w-100">
                                    <select name="height" title="Height" required class=" w-100 selectpicker">
                                ...
                                <div class="select-box  w-100 d-block" style="margin: auto;">
                                    <select name="brest_size" title="Breast size" required class="selectpicker  w-100">
                            ...
                            <div class="container-checkbox">
                                <div class="box-checkbox">
                                    ...
                                    <label class="drop__input-box">
                                        <input class="checkbox drop__input-trigger" type="checkbox" value="1"
                                               name="incall_30m">
                                        <span class="checkbox-custom"></span>
                                        <span class="label">30 minutes</span>
                                        <div class="input-box drop__input disabled">
                                            <input type="number" class="input-disabled" name="incall_30m_rate" placeholder="Rate">
                                        </div>
                                    </label>
                                    <label class="drop__input-box">
                                        <input class="checkbox drop__input-trigger" type="checkbox" value="1"
                                        ...
                                        <div class="input-box drop__input disabled">
                                            <input type="number" class="input-disabled" name="incall_1h_rate" placeholder="Rate">
                                        </div>
                                    </label>
                                    <label class="drop__input-box">
                                        <input class="checkbox drop__input-trigger" type="checkbox" value="1"
                                        ...
                                        <div class="input-box drop__input disabled">
                                            <input type="number" class="input-disabled" name="incall_2h_rate" placeholder="Rate">
                                        </div>
                                    </label>
                                    <label class="drop__input-box">
                                        <input class="checkbox drop__input-trigger" type="checkbox" value="1"
                                        ...
                                        <div class="input-box drop__input disabled">
                                            <input type="number" class="input-disabled" name="incall_24h_rate" placeholder="Rate">
                                        </div>
                                    </label>
                                </div>
                                <div class="box-checkbox">
                                    ...
                                    <label class="drop__input-box">
                                        ...
                                        <span class="label">30 minutes</span>
                                        <div class="input-box drop__input disabled">
                                            <input type="number" class="input-disabled" name="outcall_30m_rate" placeholder="Rate">
                                        </div>
                                    </label>
                                    <label class="drop__input-box">
                                        <input class="checkbox drop__input-trigger" type="checkbox" value="1"
                                        ...
                                        <span class="label">1 hour</span>
                                        <div class="input-box drop__input disabled">
                                            <input type="number" class="input-disabled" name="outcall_1h_rate" placeholder="Rate">
                                        </div>
                                    </label>
                                    <label class="drop__input-box">
                                        <input class="checkbox drop__input-trigger" type="checkbox" value="1"
                                        ...
                                        <span class="label">2 hours</span>
                                        <div class="input-box drop__input disabled">
                                            <input type="number" class="input-disabled" name="outcall_2h_rate" placeholder="Rate">
                                        </div>
                                    </label>
                                    <label class="drop__input-box">
                                        <input class="checkbox drop__input-trigger" type="checkbox" value="1"
                                        ...
                                        <span class="label"> 24 hours</span>
                                        <div class="input-box drop__input disabled">
                                            <input type="number" class="input-disabled" name="outcall_24h_rate" placeholder="Rate">
                                        </div>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="select-container w-100 d-block">
                                <div class="select-box w-100 d-block">
                                    <select name="currency[]" title="Currency" required multiple class="w-100 d-block selectpicker" data-selected-text-format="count">
                                        @foreach($params_currency as $item)
                                            <option value="{{ $item->name_id }}">{{$item->name}}</option>
                                        @endforeach;
                                    </select>
                                </div>
                                <div class="select-box w-100 d-block ml-0 ">
                                    <select title="Payment accepted" name="payment_accepted[]" multiple required class="selectpicker payment__selector w-100 d-block ml-0" data-selected-text-format="count">

                                        @foreach($params_paymentAccepted as $item)
                                            <option value="{{ $item->name_id }}">{{$item->name}}</option>
                                        @endforeach;
                            ...
                            <div class="input-box payment__input disabled">
                                <input type="text" class="input-disabled" id="custom_currency" name="custom_currency" placeholder="Enter Your payment accepted" >
                            </div>
                            <p class="form-sm-title">Your website:</p>
                            <div class="input-box">
                                <input type="url"  pattern="https://.*" class="input-disabled" name="site" placeholder="https://Your site">
                            </div>
                            <div class="input-box FLEX">
                                <img src="{{asset('img/icon/fb-dark.svg')}}" alt="icon">
                                <input type="url"  pattern="https://www.facebook.com/*"  class="input-disabled" name="social_fb" placeholder="Facebook, e.g. yourNickname">
                            </div>
                            <div class="input-box FLEX">
                                <img src="{{asset('img/icon/in-dark.svg')}}" alt="icon">
                                <input type="url"  pattern="https://www.instagram.com*"  class="input-disabled" name="social_instagam" placeholder="Instagram, e.g. yourNickname">
                            </div>
                            <div class="input-box FLEX">
                                <img src="{{asset('img/icon/tw-dark.svg')}}" alt="icon">
                                <input type="url"  pattern="https://twitter.com*"  class="input-disabled" name="social_twitter" placeholder="Twitter, e.g. yourNickname">
                            </div>
                           <!--  <div class="input-box FLEX">
                                <img src="{{asset('img/icon/go-dark.svg')}}" alt="icon">
                                <input type="url"   class="input-disabled" name="social_google_plus" placeholder="Google plus">
                            </div> -->
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="updating-box-1">
                            ...
                            <div class="blockPremium">
                                <label>
                                    <input class="checkbox" type="radio" value="premium" name="rate">
                                    <span class="checkbox-custom"></span>
                    ...
                    <div class="col-xl-5 col-lg-6">
                        ...
                        <div class="blockRegularAd">
                            <div class="updating-box-2">
                                <label>
                                    <input class="checkbox" type="radio" value="regular" id="regularRate" name="rate" checked>
                                    <span class="checkbox-custom"></span>
                             ...
                             <!--        <p class="info-prime">Your listing will be bumped in both sections “Prime” and “Regular”.
                                ...
                                <div class="small-checkbox">
                                    <label>
                                        <input class="checkbox" type="checkbox" name="oneMostDollar" id="oneMostDollar" checked>
                                        <span class="checkbox-custom"></span>
            ...
            <input type="hidden" name="totalPrice" id="totalPrice" value="1" >
            <div class="send-about">
                <div class="send-about-text">
                    ...
                    <p class="pMoney--price">Ad cost - <span><span id="pMoney--price">1</span>$</span></p>
                    @php
                        $afterMoney = (Auth::user()->money - 1);
